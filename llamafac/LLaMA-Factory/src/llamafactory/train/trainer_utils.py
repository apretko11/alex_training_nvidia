...
class SafeDeepSpeedTrainer(Trainer):
    """
    A Trainer subclass that avoids Accelerate's no_sync() incompatibility
    with DeepSpeed ZeRO stage 2/3. It calls backward/step directly.
    """
